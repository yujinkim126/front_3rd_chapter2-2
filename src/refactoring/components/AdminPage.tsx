...
export const AdminPage = ({
  ...
  const { newProduct, setNewProduct, resetNewProduct } = useAdminProduct(); // 상품 정보 관련 훅
  const {
    showNewProductForm,
    editingProduct,
    setEditingProduct,
  ...
  const handleAddNewProduct = () => {
    ...
    resetNewProduct();
    // toggleNewProductForm(productWithId.id);
  };
    ...
    <div className="container mx-auto p-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
          ...
          >
            {showNewProductForm && showNewProductForm ? "취소" : "새 상품 추가"}
          </button>
          {openProductIds && (
